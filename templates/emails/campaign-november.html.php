        ...
        <table width='620' cellpadding='24' cellspacing='0' style='max-width:620px;border:1px solid #eee;'>
          <tr>
            <td>
              ...
              <h2 style='margin:0 0 15px 0;font-size:22px;color:#000000;'><?php echo esc_html__( 'November Mega Offer: {discount_percentage}% Off', 'wrpa' ); ?></h2>
              <p style='margin:0 0 10px 0;font-size:16px;'><?php echo esc_html__( 'Hi {user_first_name},', 'wrpa' ); ?></p>
              <p style='margin:0 0 18px 0;font-size:15px;line-height:1.5;'><?php echo esc_html__( 'Our biggest savings of the year are here. Join the {plan_name} plan with {discount_percentage}% off before {campaign_end_date} and unlock every masterclass, ritual library, and community event inside {site_name}.', 'wrpa' ); ?></p>
              <p style='margin:0 0 18px 0;font-size:15px;line-height:1.5;'><?php echo esc_html__( 'During November you will also receive bonus workshop recordings and downloadable workbooks to support your goals. Act now while the offer is live.', 'wrpa' ); ?></p>
              <p style='margin:0 0 18px 0;font-size:15px;line-height:1.5;'>
                ...
                echo wp_kses(
                    sprintf(
                        ...
                        __( 'If you need help choosing the right path, write to %s and our team will guide you.', 'wrpa' ),
                        $support_link
                    ),
                    [ 'a' => [ 'href' => [], 'style' => [] ] ]
                );
              ...
              <p style='margin:26px 0;'>
                <a href='{subscribe_url}' style='display:inline-block;padding:12px 24px;text-decoration:none;border-radius:6px;
                  ...
                  <?php echo esc_html__( 'Claim the Discount', 'wrpa' ); ?>
                </a>
              </p>
